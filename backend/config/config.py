...
NO_BEHAVIOR_SCORE_CAP = 0.20
NO_EVIDENCE_SCORE_CAP = 0.35
WEAK_EVIDENCE_SCORE_CAP = 0.55
...
BERT_MAX_SAMPLES    = 50000
BERT_MAX_LENGTH     = 192
BERT_TRAIN_EPOCHS   = 2
BERT_TRAIN_BATCH    = 8
BERT_EVAL_BATCH     = 16
BERT_GRADIENT_ACCUMULATION_STEPS = 4
BERT_LEARNING_RATE  = 2e-5
BERT_WEIGHT_DECAY   = 0.01
BERT_WARMUP_STEPS   = 500
SYNTHETIC_FRAUD_COUNT = 900
SYNTHETIC_SAFE_COUNT  = 900
